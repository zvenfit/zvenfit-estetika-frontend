...
while ! YDB_ACCESS_TOKEN_CREDENTIALS="${YDB_IAM_TOKEN}" \
  ...
  YDB_NEWSLETTER_SUBSCRIPTIONS_TABLE="${YDB_NEWSLETTER_SUBSCRIPTIONS_TABLE}" \
  YDB_NEWSLETTER_CONSENT_EVENTS_TABLE="${YDB_NEWSLETTER_CONSENT_EVENTS_TABLE}" \
  YDB_TELEGRAM_OUTBOX_TABLE="${YDB_TELEGRAM_OUTBOX_TABLE}" \
