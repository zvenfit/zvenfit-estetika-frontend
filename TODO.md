...
- [x] `npm test` проходит: линтер, strict TypeScript, 35 unit-тестов Cloud Function, проверка CommonJS-артефакта, 18 contract-тестов CI/monitoring/parity и production-сборка (проверено 2026-08-12)
- [x] `npm run test:visual`: 27 визуальных и функциональных сценариев для desktop, tablet и mobile проходят (проверено 2026-08-12)
