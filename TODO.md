...
- [x] **Определиться с `www`** — несуществующий `www.estetika.zvenfit.ru` удалён из production CORS; возвращать его только одновременно с DNS, TLS и редиректом на основной домен
