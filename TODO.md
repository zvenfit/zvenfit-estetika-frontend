...
- [ ] **Юридическая проверка форм до приёма заявок** — раздельные явные согласия технически реализованы и сохраняются с версией в YDB; остаётся подтвердить формулировки с юристом
